...
from mscn import compute_image_mscn_transform
from stats import aggd_features, paired_product
import skvideo.io
...
def niqe(inputVideoPath):
    ...
    # load the video data using cap = cv2.VideoCapture("./data/1.MP4")
...
if __name__ == "__main__":
    ...
    niqe_scores = niqe(video_path)
    print("NIQE scores for each frame:")
