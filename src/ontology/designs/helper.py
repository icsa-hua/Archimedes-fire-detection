...
def eye_mouth_state_rules(): 
    ...
    print("[checked] EyeState rules have also been set correctly")
...
def set_up_HR_rules():
    ...
    * High 
    ...
    print("[checked] HR rules set correctly")
...
def set_up_HRV_rules():
    ...
    print("[checked] HRV rules set correctly")
...
def set_up_RR_rules(): 
    ...
    print("[checked] RR rules set correctly")
...
def set_up_SpO2_rules(): 
    ...
    * Critical
    ...
    print("[checked] SpO2 rules set correctly")
...
def set_up_Drowsiness_rules(): 
    ...
    print("[checked] Drowsiness rules set correctly")
